...
Run Jupiter nootbook 'quantum_test_data_explore.ipynb' to prepare working data directories for the developed model
The training set of images and the corresponding masks should be placed in subdirectories 'img_train/images' and 'img_train/masks', respectively
Test images should be placed in a subdirectory 'img_test/images'
...
- select the tested version of the pretrained model by specifying the corresponding value of the hyperparameter 'epoch'
